...
%union {
    ...
    struct ast_interface_class_declaration              *ast_interface_class_declaration;
    struct ast_interface_class_item                     *ast_interface_class_item;
    struct ast_interface_class_method                   *ast_interface_class_method;
    ...
    struct ast_sign                                     *ast_sign;
    struct ast_size                                     *ast_size;
    struct ast_non_zero_unsigned_number                 *ast_non_zero_unsigned_number;
    struct ast_real_number                              *ast_real_number;
    struct ast_fixed_point_number                       *ast_fixed_point_number;
    struct ast_exp                                      *ast_exp;
    struct ast_unsigned_number                          *ast_unsigned_number;
    struct ast_binary_value                             *ast_binary_value;
    struct ast_octal_value                              *ast_octal_value;
    struct ast_hex_value                                *ast_hex_value;
    struct ast_decimal_base                             *ast_decimal_base;
    struct ast_binary_base                              *ast_binary_base;
    struct ast_octal_base                               *ast_octal_base;
    struct ast_hex_base                                 *ast_hex_base;
    struct ast_non_zero_decimal_digit                   *ast_non_zero_decimal_digit;
    struct ast_decimal_digit                            *ast_decimal_digit;
    struct ast_binary_digit                             *ast_binary_digit;
    struct ast_octal_digit                              *ast_octal_digit;
    struct ast_hex_digit                                *ast_hex_digit;
    struct ast_x_digit                                  *ast_x_digit;
    struct ast_z_digit                                  *ast_z_digit;
    ...
    struct ast_comment                                  *ast_comment;
    struct ast_one_line_comment                         *ast_one_line_comment;
    struct ast_block_comment                            *ast_block_comment;
    struct ast_comment_text                             *ast_comment_text;
    struct ast_array_identifier                         *ast_array_identifier;
    ...
    struct ast_covergroup_variable_identifier           *ast_covergroup_variable_identifier;
    ...
    struct ast_formal_identifier                        *ast_formal_identifier;
    ...
    struct ast_white_space                              *ast_white_space;
...
%token TOKEN_24    /* pure */
%token TOKEN_25    /* package */
%token TOKEN_26    /* endpackage */
%token TOKEN_27    /* timeunit */
%token TOKEN_28    /* / */
%token TOKEN_29    /* timeprecision */
%token TOKEN_30    /* # */
%token TOKEN_31    /* type */
%token TOKEN_32    /* . */
%token TOKEN_33    /* { */
%token TOKEN_34    /* } */
%token TOKEN_35    /* input */
%token TOKEN_36    /* output */
%token TOKEN_37    /* inout */
%token TOKEN_38    /* ref */
%token TOKEN_39    /* = */
%token TOKEN_40    /* dollarsign_fatal */
%token TOKEN_41    /* dollarsign_error */
%token TOKEN_42    /* dollarsign_warning */
%token TOKEN_43    /* dollarsign_info */
%token TOKEN_44    /* 0 */
%token TOKEN_45    /* 1 */
%token TOKEN_46    /* 2 */
%token TOKEN_47    /* default */
%token TOKEN_48    /* clocking */
%token TOKEN_49    /* disable */
%token TOKEN_50    /* iff */
%token TOKEN_51    /* defparam */
%token TOKEN_52    /* bind */
%token TOKEN_53    /* config */
%token TOKEN_54    /* endconfig */
%token TOKEN_55    /* design */
%token TOKEN_56    /* instance */
%token TOKEN_57    /* cell */
%token TOKEN_58    /* liblist */
%token TOKEN_59    /* use */
%token TOKEN_60    /* forkjoin */
%token TOKEN_61    /* rand */
%token TOKEN_62    /* const */
...
%token TOKEN_176   /* endsequence */
%token TOKEN_177   /* untyped */
%token TOKEN_178   /* ## */
%token TOKEN_179   /* [*] */
%token TOKEN_180   /* [+] */
%token TOKEN_181   /* [* */
%token TOKEN_182   /* [= */
%token TOKEN_183   /* [-> */
%token TOKEN_184   /* dist */
%token TOKEN_185   /* let */
%token TOKEN_186   /* covergroup */
%token TOKEN_187   /* endgroup */
%token TOKEN_188   /* option */
%token TOKEN_189   /* type_option */
%token TOKEN_190   /* sample */
%token TOKEN_191   /* @@ */
%token TOKEN_192   /* begin */
%token TOKEN_193   /* end */
%token TOKEN_194   /* coverpoint */
%token TOKEN_195   /* bins */
%token TOKEN_196   /* illegal_bins */
%token TOKEN_197   /* ignore_bins */
%token TOKEN_198   /* => */
%token TOKEN_199   /* cross */
%token TOKEN_200   /* ! */
%token TOKEN_201   /* && */
%token TOKEN_202   /* || */
%token TOKEN_203   /* matches */
%token TOKEN_204   /* binsof */
%token TOKEN_205   /* intersect */
%token TOKEN_206   /* pulldown */
%token TOKEN_207   /* pullup */
%token TOKEN_208   /* cmos */
%token TOKEN_209   /* rcmos */
%token TOKEN_210   /* bufif0 */
%token TOKEN_211   /* bufif1 */
%token TOKEN_212   /* notif0 */
%token TOKEN_213   /* notif1 */
%token TOKEN_214   /* nmos */
%token TOKEN_215   /* pmos */
%token TOKEN_216   /* rnmos */
%token TOKEN_217   /* rpmos */
%token TOKEN_218   /* and */
%token TOKEN_219   /* nand */
%token TOKEN_220   /* or */
%token TOKEN_221   /* nor */
%token TOKEN_222   /* xor */
%token TOKEN_223   /* xnor */
%token TOKEN_224   /* buf */
%token TOKEN_225   /* not */
%token TOKEN_226   /* tranif0 */
%token TOKEN_227   /* tranif1 */
%token TOKEN_228   /* rtranif0 */
%token TOKEN_229   /* rtranif1 */
%token TOKEN_230   /* tran */
%token TOKEN_231   /* rtran */
%token TOKEN_232   /* generate */
%token TOKEN_233   /* endgenerate */
%token TOKEN_234   /* for */
%token TOKEN_235   /* case */
%token TOKEN_236   /* endcase */
%token TOKEN_237   /* primitive */
%token TOKEN_238   /* endprimitive */
%token TOKEN_239   /* table */
%token TOKEN_240   /* endtable */
%token TOKEN_241   /* initial */
%token TOKEN_242   /* 1'b0 */
%token TOKEN_243   /* 1'b1 */
%token TOKEN_244   /* 1'bx */
%token TOKEN_245   /* 1'bX */
%token TOKEN_246   /* 1'B0 */
%token TOKEN_247   /* 1'B1 */
%token TOKEN_248   /* 1'Bx */
%token TOKEN_249   /* 1'BX */
%token TOKEN_250   /* x */
%token TOKEN_251   /* X */
%token TOKEN_252   /* ? */
%token TOKEN_253   /* b */
...
%token TOKEN_261   /* n */
%token TOKEN_262   /* N */
%token TOKEN_263   /* assign */
%token TOKEN_264   /* alias */
%token TOKEN_265   /* always */
%token TOKEN_266   /* always_comb */
%token TOKEN_267   /* always_latch */
%token TOKEN_268   /* always_ff */
%token TOKEN_269   /* final */
%token TOKEN_270   /* += */
%token TOKEN_271   /* -= */
%token TOKEN_272   /* *= */
%token TOKEN_273   /* /= */
...
%token TOKEN_280   /* <<<= */
%token TOKEN_281   /* >>>= */
%token TOKEN_282   /* deassign */
%token TOKEN_283   /* force */
%token TOKEN_284   /* release */
%token TOKEN_285   /* fork */
%token TOKEN_286   /* join */
%token TOKEN_287   /* join_any */
%token TOKEN_288   /* join_none */
%token TOKEN_289   /* repeat */
%token TOKEN_290   /* @ */
%token TOKEN_291   /* return */
%token TOKEN_292   /* break */
%token TOKEN_293   /* continue */
%token TOKEN_294   /* wait */
%token TOKEN_295   /* wait_order */
%token TOKEN_296   /* ->> */
%token TOKEN_297   /* unique0 */
%token TOKEN_298   /* priority */
%token TOKEN_299   /* &&& */
%token TOKEN_300   /* inside */
%token TOKEN_301   /* casex */
%token TOKEN_302   /* casez */
%token TOKEN_303   /* randcase */
%token TOKEN_304   /* ' */
%token TOKEN_305   /* forever */
%token TOKEN_306   /* while */
%token TOKEN_307   /* do */
%token TOKEN_308   /* #0 */
%token TOKEN_309   /* endclocking */
%token TOKEN_310   /* global */
%token TOKEN_311   /* randsequence */
%token TOKEN_312   /* | */
%token TOKEN_313   /* specify */
%token TOKEN_314   /* endspecify */
%token TOKEN_315   /* pulsestyle_onevent */
%token TOKEN_316   /* pulsestyle_ondetect */
%token TOKEN_317   /* showcancelled */
%token TOKEN_318   /* noshowcancelled */
%token TOKEN_319   /* *> */
%token TOKEN_320   /* posedge */
%token TOKEN_321   /* negedge */
%token TOKEN_322   /* edge */
%token TOKEN_323   /* ifnone */
%token TOKEN_324   /* dollarsign_setup */
%token TOKEN_325   /* dollarsign_hold */
%token TOKEN_326   /* dollarsign_setuphold */
%token TOKEN_327   /* dollarsign_recovery */
%token TOKEN_328   /* dollarsign_removal */
%token TOKEN_329   /* dollarsign_recrem */
%token TOKEN_330   /* dollarsign_skew */
%token TOKEN_331   /* dollarsign_timeskew */
%token TOKEN_332   /* dollarsign_fullskew */
%token TOKEN_333   /* dollarsign_period */
%token TOKEN_334   /* dollarsign_width */
%token TOKEN_335   /* dollarsign_nochange */
%token TOKEN_336   /* 01 */
%token TOKEN_337   /* 10 */
%token TOKEN_338   /* z */
%token TOKEN_339   /* Z */
...
%token TOKEN_350   /* -: */
%token TOKEN_351   /* std:: */
%token TOKEN_352   /* randomize */
%token TOKEN_353   /* null */
%token TOKEN_354   /* this */
%token TOKEN_355   /* local:: */
%token TOKEN_356   /* s */
%token TOKEN_357   /* ms */
%token TOKEN_358   /* us */
%token TOKEN_359   /* ns */
...
%token TOKEN_396   /* (* */
%token TOKEN_397   /* *) */
%token TOKEN_398   /* dollarsign_unit */
...
%type <ast_interface_class_declaration>                interface_class_declaration
%type <ast_interface_class_item>                       interface_class_item
%type <ast_interface_class_method>                     interface_class_method
...
%type <ast_sign>                                       sign
%type <ast_size>                                       size
%type <ast_non_zero_unsigned_number>                   non_zero_unsigned_number
%type <ast_real_number>                                real_number
%type <ast_fixed_point_number>                         fixed_point_number
%type <ast_exp>                                        exp
%type <ast_unsigned_number>                            unsigned_number
%type <ast_binary_value>                               binary_value
%type <ast_octal_value>                                octal_value
%type <ast_hex_value>                                  hex_value
%type <ast_decimal_base>                               decimal_base
%type <ast_binary_base>                                binary_base
%type <ast_octal_base>                                 octal_base
%type <ast_hex_base>                                   hex_base
%type <ast_non_zero_decimal_digit>                     non_zero_decimal_digit
%type <ast_decimal_digit>                              decimal_digit
%type <ast_binary_digit>                               binary_digit
%type <ast_octal_digit>                                octal_digit
%type <ast_hex_digit>                                  hex_digit
%type <ast_x_digit>                                    x_digit
%type <ast_z_digit>                                    z_digit
...
%type <ast_comment>                                    comment
%type <ast_one_line_comment>                           one_line_comment
%type <ast_block_comment>                              block_comment
%type <ast_comment_text>                               comment_text
%type <ast_array_identifier>                           array_identifier
...
%type <ast_covergroup_variable_identifier>             covergroup_variable_identifier
...
%type <ast_formal_identifier>                          formal_identifier
...
%type <ast_white_space>                                white_space
...
%type <ast_list> LIST_163
%type <ast_list> LIST_164
%type <ast_list> LIST_165
%type <ast_list> LIST_166
%type <ast_list> LIST_167
%type <ast_list> OPT_0
%type <ast_list> OPT_1
%type <ast_list> OPT_2
%type <ast_list> OPT_3
...
%type <ast_list> STAR_53
%type <ast_list> STAR_54
%type <ast_list> STAR_55
%type <ast_list> STAR_56
...
library_declaration 
    : TOKEN_1 /* library */ library_identifier LIST_1 OPT_0 
    {
...
module_nonansi_header 
    : STAR_2 module_keyword OPT_2 module_identifier STAR_3 OPT_3 list_of_ports TOKEN_0 /* ; */ 
    {
		...
		fprintf(stderr, "NONANSI_HEADER(%p, %p)\n", $2, $4);
        $$ = ret;
    }
    ;
...
module_ansi_header 
    : STAR_2 module_keyword OPT_2 module_identifier STAR_3 OPT_3 OPT_4 TOKEN_0 /* ; */ 
    {
		...
		fprintf(stderr, "ANSI_HEADER(%p, %p)\n", $2, $4);
        $$ = ret;
    }
    ;
...
module_keyword 
    : TOKEN_8 /* module */ 
    {
		...
		fprintf(stderr, "MODULE_KEYWORD(%s)\n", $1);
        $$ = ret;
    }
    | TOKEN_9 /* macromodule */ 
    {
...
interface_class_declaration 
    : TOKEN_11 /* interface */ TOKEN_20 /* class */ class_identifier OPT_3 OPT_17 TOKEN_0 /* ; */ STAR_12 TOKEN_23 /* endclass */ OPT_15 
    {
        struct ast_interface_class_declaration *ret = new (struct ast_interface_class_declaration);
        $$ = ret;
    }
    ;
...
interface_class_item 
    : type_declaration 
    {
        struct ast_interface_class_item *ret = new (struct ast_interface_class_item);
        $$ = ret;
    }
    | STAR_2 interface_class_method 
    {
        struct ast_interface_class_item *ret = new (struct ast_interface_class_item);
        $$ = ret;
    }
...
interface_class_method 
    : TOKEN_24 /* pure */ TOKEN_19 /* virtual */ method_prototype TOKEN_0 /* ; */ 
    {
        struct ast_interface_class_method *ret = new (struct ast_interface_class_method);
        $$ = ret;
    }
    ;

package_declaration 
    : STAR_2 TOKEN_25 /* package */ OPT_2 package_identifier TOKEN_0 /* ; */ OPT_1 STAR_13 TOKEN_26 /* endpackage */ OPT_18 
    {
...
timeunits_declaration 
    : TOKEN_27 /* timeunit */ time_literal OPT_19 TOKEN_0 /* ; */ 
    {
        struct ast_timeunits_declaration *ret = new (struct ast_timeunits_declaration);
        $$ = ret;
    }
    | TOKEN_29 /* timeprecision */ time_literal TOKEN_0 /* ; */ 
    {
        struct ast_timeunits_declaration *ret = new (struct ast_timeunits_declaration);
        $$ = ret;
    }
    | TOKEN_27 /* timeunit */ time_literal TOKEN_0 /* ; */ TOKEN_29 /* timeprecision */ time_literal TOKEN_0 /* ; */ 
    {
        struct ast_timeunits_declaration *ret = new (struct ast_timeunits_declaration);
        $$ = ret;
    }
    | TOKEN_29 /* timeprecision */ time_literal TOKEN_0 /* ; */ TOKEN_27 /* timeunit */ time_literal TOKEN_0 /* ; */ 
    {
        struct ast_timeunits_declaration *ret = new (struct ast_timeunits_declaration);
        $$ = ret;
    }
...
parameter_port_list 
    : TOKEN_30 /* # */ TOKEN_12 /* ( */ list_of_param_assignments STAR_14 TOKEN_14 /* ) */ 
    {
        struct ast_parameter_port_list *ret = new (struct ast_parameter_port_list);
        $$ = ret;
    }
    | TOKEN_30 /* # */ TOKEN_12 /* ( */ LIST_17 TOKEN_14 /* ) */ 
    {
        struct ast_parameter_port_list *ret = new (struct ast_parameter_port_list);
        $$ = ret;
    }
    | TOKEN_30 /* # */ TOKEN_12 /* ( */ TOKEN_14 /* ) */ 
    {
        struct ast_parameter_port_list *ret = new (struct ast_parameter_port_list);
        $$ = ret;
    }
...
parameter_port_declaration 
    ...
    | TOKEN_31 /* type */ list_of_type_assignments 
    {
        struct ast_parameter_port_declaration *ret = new (struct ast_parameter_port_declaration);
        $$ = ret;
    }
...
port 
    ...
    | TOKEN_32 /* . */ port_identifier TOKEN_12 /* ( */ OPT_21 TOKEN_14 /* ) */ 
    {
        struct ast_port *ret = new (struct ast_port);
        $$ = ret;
    }
...
ansi_port_declaration 
    : OPT_24 port_identifier STAR_15 OPT_25 
    {
        struct ast_ansi_port_declaration *ret = new (struct ast_ansi_port_declaration);
        $$ = ret;
    }
    | OPT_26 port_identifier STAR_16 OPT_25 
    {
        struct ast_ansi_port_declaration *ret = new (struct ast_ansi_port_declaration);
        $$ = ret;
    }
    | OPT_22 TOKEN_32 /* . */ port_identifier TOKEN_12 /* ( */ OPT_27 TOKEN_14 /* ) */ 
    {
        struct ast_ansi_port_declaration *ret = new (struct ast_ansi_port_declaration);
        $$ = ret;
    }
...
elaboration_system_task 
    : TOKEN_40 /* dollarsign_fatal */ OPT_29 TOKEN_0 /* ; */ 
    {
        struct ast_elaboration_system_task *ret = new (struct ast_elaboration_system_task);
        $$ = ret;
    }
    | TOKEN_41 /* dollarsign_error */ OPT_31 TOKEN_0 /* ; */ 
    {
        struct ast_elaboration_system_task *ret = new (struct ast_elaboration_system_task);
        $$ = ret;
    }
    | TOKEN_42 /* dollarsign_warning */ OPT_31 TOKEN_0 /* ; */ 
    {
        struct ast_elaboration_system_task *ret = new (struct ast_elaboration_system_task);
        $$ = ret;
    }
    | TOKEN_43 /* dollarsign_info */ OPT_31 TOKEN_0 /* ; */ 
    {
        struct ast_elaboration_system_task *ret = new (struct ast_elaboration_system_task);
        $$ = ret;
    }
...
module_or_generate_item_declaration 
    ...
    | TOKEN_47 /* default */ TOKEN_48 /* clocking */ clocking_identifier TOKEN_0 /* ; */ 
    {
        struct ast_module_or_generate_item_declaration *ret = new (struct ast_module_or_generate_item_declaration);
        $$ = ret;
    }
    | TOKEN_47 /* default */ TOKEN_49 /* disable */ TOKEN_50 /* iff */ expression_or_dist TOKEN_0 /* ; */ 
    {
        struct ast_module_or_generate_item_declaration *ret = new (struct ast_module_or_generate_item_declaration);
        $$ = ret;
    }
...
parameter_override 
    : TOKEN_51 /* defparam */ list_of_defparam_assignments TOKEN_0 /* ; */ 
    {
...
bind_directive 
    : TOKEN_52 /* bind */ bind_target_scope OPT_32 bind_instantiation TOKEN_0 /* ; */ 
    {
        struct ast_bind_directive *ret = new (struct ast_bind_directive);
        $$ = ret;
    }
    | TOKEN_52 /* bind */ bind_target_instance bind_instantiation TOKEN_0 /* ; */ 
    {
        struct ast_bind_directive *ret = new (struct ast_bind_directive);
        $$ = ret;
    }
...
config_declaration 
    : TOKEN_53 /* config */ config_identifier TOKEN_0 /* ; */ STAR_17 design_statement STAR_18 TOKEN_54 /* endconfig */ OPT_33 
    {
...
design_statement 
    : TOKEN_55 /* design */ STAR_19 TOKEN_0 /* ; */ 
    {
...
cell_clause 
    : TOKEN_57 /* cell */ OPT_34 cell_identifier 
    {
...
use_clause 
    : TOKEN_59 /* use */ OPT_34 cell_identifier OPT_35 
    {
        struct ast_use_clause *ret = new (struct ast_use_clause);
        $$ = ret;
    }
    | TOKEN_59 /* use */ LIST_29 OPT_35 
    {
        struct ast_use_clause *ret = new (struct ast_use_clause);
        $$ = ret;
    }
    | TOKEN_59 /* use */ OPT_34 cell_identifier LIST_29 OPT_35 
    {
        struct ast_use_clause *ret = new (struct ast_use_clause);
        $$ = ret;
    }
...
extern_tf_declaration 
    ...
    | TOKEN_7 /* extern */ TOKEN_60 /* forkjoin */ task_prototype TOKEN_0 /* ; */ 
    {
        struct ast_extern_tf_declaration *ret = new (struct ast_extern_tf_declaration);
        $$ = ret;
    }
...
checker_port_item 
    : STAR_2 OPT_36 property_formal_type formal_port_identifier STAR_16 OPT_37 
    {
...
class_property 
    : STAR_22 data_declaration 
    {
        struct ast_class_property *ret = new (struct ast_class_property);
        $$ = ret;
    }
    | TOKEN_62 /* const */ STAR_23 data_type const_identifier OPT_25 TOKEN_0 /* ; */ 
    {
        struct ast_class_property *ret = new (struct ast_class_property);
        $$ = ret;
    }
...
class_method 
    : STAR_24 task_declaration 
    {
        struct ast_class_method *ret = new (struct ast_class_method);
        $$ = ret;
    }
    | STAR_24 function_declaration 
    {
        struct ast_class_method *ret = new (struct ast_class_method);
        $$ = ret;
    }
    | TOKEN_24 /* pure */ TOKEN_19 /* virtual */ STAR_23 method_prototype TOKEN_0 /* ; */ 
    {
        struct ast_class_method *ret = new (struct ast_class_method);
        $$ = ret;
    }
    | TOKEN_7 /* extern */ STAR_24 method_prototype TOKEN_0 /* ; */ 
    {
        struct ast_class_method *ret = new (struct ast_class_method);
        $$ = ret;
    }
    | STAR_24 class_constructor_declaration 
    {
        struct ast_class_method *ret = new (struct ast_class_method);
        $$ = ret;
    }
    | TOKEN_7 /* extern */ STAR_24 class_constructor_prototype 
    {
        struct ast_class_method *ret = new (struct ast_class_method);
        $$ = ret;
    }
...
class_constructor_prototype 
    : TOKEN_63 /* function */ TOKEN_64 /* new */ OPT_40 TOKEN_0 /* ; */ 
    {
...
class_constructor_declaration 
    : TOKEN_63 /* function */ OPT_42 TOKEN_64 /* new */ OPT_40 TOKEN_0 /* ; */ STAR_25 OPT_43 STAR_26 TOKEN_70 /* endfunction */ OPT_44 
    {
...
constraint_declaration 
    : OPT_45 TOKEN_71 /* constraint */ constraint_identifier constraint_block 
    {
...
constraint_primary 
    : OPT_46 hierarchical_identifier select 
    {
...
constraint_expression 
    : OPT_47 expression_or_dist TOKEN_0 /* ; */ 
    {
    ...
    | TOKEN_76 /* if */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ constraint_set OPT_48 
    {
        struct ast_constraint_expression *ret = new (struct ast_constraint_expression);
        $$ = ret;
    }
    ...
    | TOKEN_49 /* disable */ TOKEN_74 /* soft */ constraint_primary TOKEN_0 /* ; */ 
    {
        struct ast_constraint_expression *ret = new (struct ast_constraint_expression);
        $$ = ret;
    }
...
uniqueness_constraint 
    : TOKEN_81 /* unique */ TOKEN_33 /* { */ open_range_list TOKEN_34 /* } */ 
    {
...
constraint_prototype 
    : OPT_50 OPT_45 TOKEN_71 /* constraint */ constraint_identifier TOKEN_0 /* ; */ 
    {
...
extern_constraint_declaration 
    : OPT_45 TOKEN_71 /* constraint */ class_scope constraint_identifier constraint_block 
    {
...
anonymous_program 
    : TOKEN_16 /* program */ TOKEN_0 /* ; */ STAR_29 TOKEN_15 /* endprogram */ 
    {
...
local_parameter_declaration 
    ...
    | TOKEN_84 /* localparam */ TOKEN_31 /* type */ list_of_type_assignments 
    {
        struct ast_local_parameter_declaration *ret = new (struct ast_local_parameter_declaration);
        $$ = ret;
    }
...
parameter_declaration 
    ...
    | TOKEN_85 /* parameter */ TOKEN_31 /* type */ list_of_type_assignments 
    {
        struct ast_parameter_declaration *ret = new (struct ast_parameter_declaration);
        $$ = ret;
    }
...
specparam_declaration 
    : TOKEN_86 /* specparam */ OPT_51 list_of_specparam_assignments TOKEN_0 /* ; */ 
    {
...
inout_declaration 
    : TOKEN_37 /* inout */ net_port_type list_of_port_identifiers 
    {
...
input_declaration 
    : TOKEN_35 /* input */ net_port_type list_of_port_identifiers 
    {
        struct ast_input_declaration *ret = new (struct ast_input_declaration);
        $$ = ret;
    }
    | TOKEN_35 /* input */ variable_port_type list_of_variable_identifiers 
    {
        struct ast_input_declaration *ret = new (struct ast_input_declaration);
        $$ = ret;
    }
...
output_declaration 
    : TOKEN_36 /* output */ net_port_type list_of_port_identifiers 
    {
        struct ast_output_declaration *ret = new (struct ast_output_declaration);
        $$ = ret;
    }
    | TOKEN_36 /* output */ variable_port_type list_of_variable_port_identifiers 
    {
        struct ast_output_declaration *ret = new (struct ast_output_declaration);
        $$ = ret;
    }
...
interface_port_declaration 
    ...
    | interface_identifier TOKEN_32 /* . */ modport_identifier list_of_interface_identifiers 
    {
        struct ast_interface_port_declaration *ret = new (struct ast_interface_port_declaration);
        $$ = ret;
    }
...
ref_declaration 
    : TOKEN_38 /* ref */ variable_port_type list_of_variable_identifiers 
    {
...
data_declaration 
    : OPT_52 OPT_53 OPT_2 data_type_or_implicit list_of_variable_decl_assignments TOKEN_0 /* ; */ 
    {
...
package_import_declaration 
    : TOKEN_88 /* import */ LIST_42 TOKEN_0 /* ; */ 
    {
...
package_export_declaration 
    ...
    | TOKEN_91 /* export */ LIST_42 TOKEN_0 /* ; */ 
    {
        struct ast_package_export_declaration *ret = new (struct ast_package_export_declaration);
        $$ = ret;
    }
...
net_declaration 
    : net_type OPT_54 OPT_55 data_type_or_implicit OPT_56 list_of_net_decl_assignments TOKEN_0 /* ; */ 
    {
        struct ast_net_declaration *ret = new (struct ast_net_declaration);
        $$ = ret;
    }
    | net_type_identifier OPT_57 list_of_net_decl_assignments TOKEN_0 /* ; */ 
    {
        struct ast_net_declaration *ret = new (struct ast_net_declaration);
        $$ = ret;
    }
    | TOKEN_96 /* interconnect */ implicit_data_type OPT_58 LIST_43 TOKEN_0 /* ; */ 
    {
        struct ast_net_declaration *ret = new (struct ast_net_declaration);
        $$ = ret;
    }
...
type_declaration 
    : TOKEN_97 /* typedef */ data_type type_identifier STAR_16 TOKEN_0 /* ; */ 
    {
        struct ast_type_declaration *ret = new (struct ast_type_declaration);
        $$ = ret;
    }
    | TOKEN_97 /* typedef */ interface_instance_identifier constant_bit_select TOKEN_32 /* . */ type_identifier type_identifier TOKEN_0 /* ; */ 
    {
        struct ast_type_declaration *ret = new (struct ast_type_declaration);
        $$ = ret;
    }
    | TOKEN_97 /* typedef */ OPT_59 type_identifier TOKEN_0 /* ; */ 
    {
        struct ast_type_declaration *ret = new (struct ast_type_declaration);
        $$ = ret;
    }
...
net_type_declaration 
    : TOKEN_101 /* nettype */ data_type net_type_identifier OPT_61 TOKEN_0 /* ; */ 
    {
        struct ast_net_type_declaration *ret = new (struct ast_net_type_declaration);
        $$ = ret;
    }
    | TOKEN_101 /* nettype */ OPT_60 net_type_identifier net_type_identifier TOKEN_0 /* ; */ 
    {
        struct ast_net_type_declaration *ret = new (struct ast_net_type_declaration);
        $$ = ret;
    }
...
data_type 
    : integer_vector_type OPT_62 STAR_30 
    {
        struct ast_data_type *ret = new (struct ast_data_type);
        $$ = ret;
    }
    | integer_atom_type OPT_62 
    {
        struct ast_data_type *ret = new (struct ast_data_type);
        $$ = ret;
    }
    ...
    | struct_union OPT_63 TOKEN_33 /* { */ LIST_45 TOKEN_34 /* } */ STAR_30 
    {
        struct ast_data_type *ret = new (struct ast_data_type);
        $$ = ret;
    }
    | TOKEN_98 /* enum */ OPT_64 TOKEN_33 /* { */ LIST_46 TOKEN_34 /* } */ STAR_30 
    {
        struct ast_data_type *ret = new (struct ast_data_type);
        $$ = ret;
    }
    ...
    | TOKEN_19 /* virtual */ OPT_65 interface_identifier OPT_16 OPT_23 
    {
        struct ast_data_type *ret = new (struct ast_data_type);
        $$ = ret;
    }
    | OPT_66 type_identifier STAR_30 
    {
        struct ast_data_type *ret = new (struct ast_data_type);
        $$ = ret;
    }
...
enum_base_type 
    ...
    | integer_vector_type OPT_62 OPT_51 
    {
        struct ast_enum_base_type *ret = new (struct ast_enum_base_type);
        $$ = ret;
    }
    | type_identifier OPT_51 
    {
        struct ast_enum_base_type *ret = new (struct ast_enum_base_type);
        $$ = ret;
    }
...
class_type 
    : ps_class_identifier OPT_16 STAR_31 
    {
...
struct_union_member 
    : STAR_2 OPT_70 data_type_or_void list_of_variable_decl_assignments TOKEN_0 /* ; */ 
    {
...
type_reference 
    : TOKEN_31 /* type */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ 
    {
        struct ast_type_reference *ret = new (struct ast_type_reference);
        $$ = ret;
    }
    | TOKEN_31 /* type */ TOKEN_12 /* ( */ data_type TOKEN_14 /* ) */ 
    {
        struct ast_type_reference *ret = new (struct ast_type_reference);
        $$ = ret;
    }
...
delay3 
    : TOKEN_30 /* # */ delay_value 
    {
        struct ast_delay3 *ret = new (struct ast_delay3);
        $$ = ret;
    }
    | TOKEN_30 /* # */ TOKEN_12 /* ( */ mintypmax_expression OPT_73 TOKEN_14 /* ) */ 
    {
        struct ast_delay3 *ret = new (struct ast_delay3);
        $$ = ret;
    }
...
delay2 
    ...
    | TOKEN_30 /* # */ TOKEN_12 /* ( */ mintypmax_expression OPT_72 TOKEN_14 /* ) */ 
    {
        struct ast_delay2 *ret = new (struct ast_delay2);
        $$ = ret;
    }
...
defparam_assignment 
    : hierarchical_parameter_identifier TOKEN_39 /* = */ constant_mintypmax_expression 
    {
...
param_assignment 
    : parameter_identifier STAR_15 OPT_74 
    {
...
specparam_assignment 
    : specparam_identifier TOKEN_39 /* = */ constant_mintypmax_expression 
    {
...
pulse_control_specparam 
    : TOKEN_148 /* PATHPULSEdollarsign_ */ TOKEN_39 /* = */ TOKEN_12 /* ( */ reject_limit_value OPT_76 TOKEN_14 /* ) */ 
    {
        struct ast_pulse_control_specparam *ret = new (struct ast_pulse_control_specparam);
        $$ = ret;
    }
    | TOKEN_148 /* PATHPULSEdollarsign_ */ specify_input_terminal_descriptor TOKEN_149 /* dollarsign_ */ specify_output_terminal_descriptor TOKEN_39 /* = */ TOKEN_12 /* ( */ reject_limit_value OPT_76 TOKEN_14 /* ) */ 
    {
        struct ast_pulse_control_specparam *ret = new (struct ast_pulse_control_specparam);
        $$ = ret;
    }
...
variable_decl_assignment 
    : variable_identifier STAR_16 OPT_74 
    {
        struct ast_variable_decl_assignment *ret = new (struct ast_variable_decl_assignment);
        $$ = ret;
    }
    | dynamic_array_variable_identifier unsized_dimension STAR_16 OPT_77 
    {
        struct ast_variable_decl_assignment *ret = new (struct ast_variable_decl_assignment);
        $$ = ret;
    }
...
function_body_declaration 
    : function_data_type_or_implicit OPT_81 function_identifier TOKEN_0 /* ; */ STAR_32 STAR_26 TOKEN_70 /* endfunction */ OPT_82 
    {
        struct ast_function_body_declaration *ret = new (struct ast_function_body_declaration);
        $$ = ret;
    }
    | function_data_type_or_implicit OPT_81 function_identifier TOKEN_12 /* ( */ OPT_39 TOKEN_14 /* ) */ TOKEN_0 /* ; */ STAR_25 STAR_26 TOKEN_70 /* endfunction */ OPT_82 
    {
        struct ast_function_body_declaration *ret = new (struct ast_function_body_declaration);
        $$ = ret;
    }
...
function_prototype 
    : TOKEN_63 /* function */ data_type_or_void function_identifier OPT_40 
    {
...
task_body_declaration 
    : OPT_81 task_identifier TOKEN_0 /* ; */ STAR_32 STAR_33 TOKEN_154 /* endtask */ OPT_86 
    {
        struct ast_task_body_declaration *ret = new (struct ast_task_body_declaration);
        $$ = ret;
    }
    | OPT_81 task_identifier TOKEN_12 /* ( */ OPT_39 TOKEN_14 /* ) */ TOKEN_0 /* ; */ STAR_25 STAR_33 TOKEN_154 /* endtask */ OPT_86 
    {
        struct ast_task_body_declaration *ret = new (struct ast_task_body_declaration);
        $$ = ret;
    }
...
tf_port_item 
    : STAR_2 OPT_87 OPT_53 data_type_or_implicit OPT_88 
    {
...
tf_port_declaration 
    : STAR_2 tf_port_direction OPT_53 data_type_or_implicit list_of_tf_variable_identifiers TOKEN_0 /* ; */ 
    {
...
task_prototype 
    : TOKEN_150 /* task */ task_identifier OPT_40 
    {
...
overload_declaration 
    : TOKEN_52 /* bind */ overload_operator TOKEN_63 /* function */ data_type function_identifier TOKEN_12 /* ( */ overload_proto_formals TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
modport_declaration 
    : TOKEN_167 /* modport */ LIST_65 TOKEN_0 /* ; */ 
    {
...
modport_item 
    : modport_identifier TOKEN_12 /* ( */ LIST_66 TOKEN_14 /* ) */ 
    {
...
modport_clocking_declaration 
    : TOKEN_48 /* clocking */ clocking_identifier 
    {
...
modport_simple_port 
    ...
    | TOKEN_32 /* . */ port_identifier TOKEN_12 /* ( */ OPT_27 TOKEN_14 /* ) */ 
    {
        struct ast_modport_simple_port *ret = new (struct ast_modport_simple_port);
        $$ = ret;
    }
...
property_declaration 
    : TOKEN_169 /* property */ property_identifier OPT_96 TOKEN_0 /* ; */ STAR_35 property_spec OPT_97 TOKEN_175 /* endproperty */ OPT_98 
    {
...
property_port_item 
    : STAR_2 OPT_100 property_formal_type formal_port_identifier STAR_16 OPT_37 
    {
...
property_case_item 
    ...
    | TOKEN_47 /* default */ OPT_101 property_expr OPT_97 
    {
        struct ast_property_case_item *ret = new (struct ast_property_case_item);
        $$ = ret;
    }
...
sequence_declaration 
    : TOKEN_173 /* sequence */ sequence_identifier OPT_103 TOKEN_0 /* ; */ STAR_35 sequence_expr OPT_97 TOKEN_176 /* endsequence */ OPT_104 
    {
...
sequence_port_item 
    : STAR_2 OPT_106 sequence_formal_type formal_port_identifier STAR_16 OPT_107 
    {
...
cycle_delay_range 
    : TOKEN_178 /* ## */ constant_primary 
    {
        struct ast_cycle_delay_range *ret = new (struct ast_cycle_delay_range);
        $$ = ret;
    }
    | TOKEN_178 /* ## */ TOKEN_79 /* [ */ cycle_delay_const_range_expression TOKEN_80 /* ] */ 
    {
        struct ast_cycle_delay_range *ret = new (struct ast_cycle_delay_range);
        $$ = ret;
    }
...
sequence_method_call 
    : sequence_instance TOKEN_32 /* . */ method_identifier 
    {
...
sequence_instance 
    : ps_or_hierarchical_sequence_identifier OPT_108 
    {
...
consecutive_repetition 
    : TOKEN_181 /* [* */ const_or_range_expression TOKEN_80 /* ] */ 
    {
...
non_consecutive_repetition 
    : TOKEN_182 /* [= */ const_or_range_expression TOKEN_80 /* ] */ 
    {
...
goto_repetition 
    : TOKEN_183 /* [-> */ const_or_range_expression TOKEN_80 /* ] */ 
    {
...
let_declaration 
    : TOKEN_185 /* let */ let_identifier OPT_112 TOKEN_39 /* = */ expression TOKEN_0 /* ; */ 
    {
...
let_port_item 
    : STAR_2 let_formal_type formal_port_identifier STAR_16 OPT_74 
    {
...
let_expression 
    : OPT_113 let_identifier OPT_115 
    {
...
covergroup_declaration 
    : TOKEN_186 /* covergroup */ covergroup_identifier OPT_40 OPT_117 TOKEN_0 /* ; */ STAR_38 TOKEN_187 /* endgroup */ OPT_118 
    {
...
coverage_option 
    : TOKEN_188 /* option */ TOKEN_32 /* . */ member_identifier TOKEN_39 /* = */ expression 
    {
        struct ast_coverage_option *ret = new (struct ast_coverage_option);
        $$ = ret;
    }
    | TOKEN_189 /* type_option */ TOKEN_32 /* . */ member_identifier TOKEN_39 /* = */ constant_expression 
    {
        struct ast_coverage_option *ret = new (struct ast_coverage_option);
        $$ = ret;
    }
...
coverage_event 
    ...
    | TOKEN_102 /* with */ TOKEN_63 /* function */ TOKEN_190 /* sample */ TOKEN_12 /* ( */ OPT_39 TOKEN_14 /* ) */ 
    {
        struct ast_coverage_event *ret = new (struct ast_coverage_event);
        $$ = ret;
    }
    | TOKEN_191 /* @@ */ TOKEN_12 /* ( */ block_event_expression TOKEN_14 /* ) */ 
    {
        struct ast_coverage_event *ret = new (struct ast_coverage_event);
        $$ = ret;
    }
...
block_event_expression 
    : TOKEN_192 /* begin */ hierarchical_btf_identifier 
    {
        struct ast_block_event_expression *ret = new (struct ast_block_event_expression);
        $$ = ret;
    }
    | TOKEN_193 /* end */ hierarchical_btf_identifier 
    {
        struct ast_block_event_expression *ret = new (struct ast_block_event_expression);
        $$ = ret;
    }
...
cover_point 
    : OPT_121 TOKEN_194 /* coverpoint */ expression OPT_122 bins_or_empty 
    {
...
bins_or_empty 
    : TOKEN_33 /* { */ STAR_2 STAR_39 TOKEN_34 /* } */ 
    {
...
bins_keyword 
    ...
    | TOKEN_196 /* illegal_bins */ 
    {
        struct ast_bins_keyword *ret = new (struct ast_bins_keyword);
        $$ = ret;
    }
    | TOKEN_197 /* ignore_bins */ 
    {
        struct ast_bins_keyword *ret = new (struct ast_bins_keyword);
        $$ = ret;
    }
...
trans_range_list 
    ...
    | trans_item TOKEN_181 /* [* */ repeat_range TOKEN_80 /* ] */ 
    {
        struct ast_trans_range_list *ret = new (struct ast_trans_range_list);
        $$ = ret;
    }
    | trans_item TOKEN_183 /* [-> */ repeat_range TOKEN_80 /* ] */ 
    {
        struct ast_trans_range_list *ret = new (struct ast_trans_range_list);
        $$ = ret;
    }
    | trans_item TOKEN_182 /* [= */ repeat_range TOKEN_80 /* ] */ 
    {
        struct ast_trans_range_list *ret = new (struct ast_trans_range_list);
        $$ = ret;
    }
...
cover_cross 
    : OPT_123 TOKEN_199 /* cross */ list_of_cross_items OPT_122 cross_body 
    {
...
bins_selection 
    : bins_keyword bin_identifier TOKEN_39 /* = */ select_expression OPT_122 
    {
...
select_expression 
    ...
    | TOKEN_200 /* ! */ select_condition 
    {
        struct ast_select_expression *ret = new (struct ast_select_expression);
        $$ = ret;
    }
    | select_expression TOKEN_201 /* && */ select_expression 
    {
        struct ast_select_expression *ret = new (struct ast_select_expression);
        $$ = ret;
    }
    | select_expression TOKEN_202 /* || */ select_expression 
    {
        struct ast_select_expression *ret = new (struct ast_select_expression);
        $$ = ret;
    }
    ...
    | select_expression TOKEN_102 /* with */ TOKEN_12 /* ( */ with_covergroup_expression TOKEN_14 /* ) */ OPT_124 
    {
        struct ast_select_expression *ret = new (struct ast_select_expression);
        $$ = ret;
    }
...
select_condition 
    : TOKEN_204 /* binsof */ TOKEN_12 /* ( */ bins_expression TOKEN_14 /* ) */ OPT_125 
    {
...
bins_expression 
    ...
    | cover_point_identifier OPT_126 
    {
        struct ast_bins_expression *ret = new (struct ast_bins_expression);
        $$ = ret;
    }
...
gate_instantiation 
    : cmos_switchtype OPT_56 LIST_91 TOKEN_0 /* ; */ 
    {
        struct ast_gate_instantiation *ret = new (struct ast_gate_instantiation);
        $$ = ret;
    }
    | enable_gatetype OPT_127 OPT_56 LIST_92 TOKEN_0 /* ; */ 
    {
        struct ast_gate_instantiation *ret = new (struct ast_gate_instantiation);
        $$ = ret;
    }
    | mos_switchtype OPT_56 LIST_93 TOKEN_0 /* ; */ 
    {
        struct ast_gate_instantiation *ret = new (struct ast_gate_instantiation);
        $$ = ret;
    }
    | n_input_gatetype OPT_127 OPT_128 LIST_94 TOKEN_0 /* ; */ 
    {
        struct ast_gate_instantiation *ret = new (struct ast_gate_instantiation);
        $$ = ret;
    }
    | n_output_gatetype OPT_127 OPT_128 LIST_95 TOKEN_0 /* ; */ 
    {
        struct ast_gate_instantiation *ret = new (struct ast_gate_instantiation);
        $$ = ret;
    }
    | pass_en_switchtype OPT_128 LIST_96 TOKEN_0 /* ; */ 
    {
        struct ast_gate_instantiation *ret = new (struct ast_gate_instantiation);
        $$ = ret;
    }
    | pass_switchtype LIST_97 TOKEN_0 /* ; */ 
    {
        struct ast_gate_instantiation *ret = new (struct ast_gate_instantiation);
        $$ = ret;
    }
    | TOKEN_206 /* pulldown */ OPT_129 LIST_98 TOKEN_0 /* ; */ 
    {
        struct ast_gate_instantiation *ret = new (struct ast_gate_instantiation);
        $$ = ret;
    }
    | TOKEN_207 /* pullup */ OPT_130 LIST_98 TOKEN_0 /* ; */ 
    {
        struct ast_gate_instantiation *ret = new (struct ast_gate_instantiation);
        $$ = ret;
    }
...
cmos_switch_instance 
    : OPT_131 TOKEN_12 /* ( */ output_terminal TOKEN_2 /* , */ input_terminal TOKEN_2 /* , */ ncontrol_terminal TOKEN_2 /* , */ pcontrol_terminal TOKEN_14 /* ) */ 
    {
...
enable_gate_instance 
    : OPT_131 TOKEN_12 /* ( */ output_terminal TOKEN_2 /* , */ input_terminal TOKEN_2 /* , */ enable_terminal TOKEN_14 /* ) */ 
    {
...
n_input_gate_instance 
    : OPT_131 TOKEN_12 /* ( */ output_terminal TOKEN_2 /* , */ LIST_99 TOKEN_14 /* ) */ 
    {
...
n_output_gate_instance 
    : OPT_131 TOKEN_12 /* ( */ LIST_100 TOKEN_14 /* ) */ 
    {
...
pass_switch_instance 
    : OPT_131 TOKEN_12 /* ( */ inout_terminal TOKEN_2 /* , */ inout_terminal TOKEN_14 /* ) */ 
    {
...
pass_enable_switch_instance 
    : OPT_131 TOKEN_12 /* ( */ inout_terminal TOKEN_2 /* , */ inout_terminal TOKEN_2 /* , */ enable_terminal TOKEN_14 /* ) */ 
    {
...
pull_gate_instance 
    : OPT_131 TOKEN_12 /* ( */ output_terminal TOKEN_14 /* ) */ 
    {
...
module_instantiation 
    : module_identifier OPT_16 LIST_101 TOKEN_0 /* ; */ 
    {
...
parameter_value_assignment 
    : TOKEN_30 /* # */ TOKEN_12 /* ( */ OPT_132 TOKEN_14 /* ) */ 
    {
...
named_parameter_assignment 
    : TOKEN_32 /* . */ parameter_identifier TOKEN_12 /* ( */ OPT_133 TOKEN_14 /* ) */ 
    {
...
hierarchical_instance 
    : name_of_instance TOKEN_12 /* ( */ OPT_134 TOKEN_14 /* ) */ 
    {
...
interface_instantiation 
    : interface_identifier OPT_16 LIST_101 TOKEN_0 /* ; */ 
    {
...
program_instantiation 
    : program_identifier OPT_16 LIST_101 TOKEN_0 /* ; */ 
    {
...
checker_instantiation 
    : ps_checker_identifier name_of_instance TOKEN_12 /* ( */ OPT_136 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
named_checker_port_connection 
    : STAR_2 TOKEN_32 /* . */ formal_port_identifier OPT_137 
    {
...
generate_region 
    : TOKEN_232 /* generate */ STAR_41 TOKEN_233 /* endgenerate */ 
    {
...
loop_generate_construct 
    : TOKEN_234 /* for */ TOKEN_12 /* ( */ genvar_initialization TOKEN_0 /* ; */ genvar_expression TOKEN_0 /* ; */ genvar_iteration TOKEN_14 /* ) */ generate_block 
    {
...
genvar_initialization 
    : OPT_138 genvar_identifier TOKEN_39 /* = */ constant_expression 
    {
...
if_generate_construct 
    : TOKEN_76 /* if */ TOKEN_12 /* ( */ constant_expression TOKEN_14 /* ) */ generate_block OPT_139 
    {
...
case_generate_construct 
    : TOKEN_235 /* case */ TOKEN_12 /* ( */ constant_expression TOKEN_14 /* ) */ case_generate_item TOKEN_33 /* { */ case_generate_item TOKEN_34 /* } */ TOKEN_236 /* endcase */ 
    {
...
case_generate_item 
    : LIST_108 TOKEN_6 /* : */ generate_block 
    {
        struct ast_case_generate_item *ret = new (struct ast_case_generate_item);
        $$ = ret;
    }
    | TOKEN_47 /* default */ OPT_101 generate_block 
    {
        struct ast_case_generate_item *ret = new (struct ast_case_generate_item);
        $$ = ret;
    }
...
generate_block 
    ...
    | OPT_140 TOKEN_192 /* begin */ OPT_141 STAR_41 TOKEN_193 /* end */ OPT_141 
    {
        struct ast_generate_block *ret = new (struct ast_generate_block);
        $$ = ret;
    }
...
udp_nonansi_declaration 
    : STAR_2 TOKEN_237 /* primitive */ udp_identifier TOKEN_12 /* ( */ udp_port_list TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
udp_ansi_declaration 
    : STAR_2 TOKEN_237 /* primitive */ udp_identifier TOKEN_12 /* ( */ udp_declaration_port_list TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
udp_declaration 
    : udp_nonansi_declaration LIST_109 udp_body TOKEN_238 /* endprimitive */ OPT_142 
    {
        struct ast_udp_declaration *ret = new (struct ast_udp_declaration);
        $$ = ret;
    }
    | udp_ansi_declaration udp_body TOKEN_238 /* endprimitive */ OPT_142 
    {
        struct ast_udp_declaration *ret = new (struct ast_udp_declaration);
        $$ = ret;
    }
    ...
    | STAR_2 TOKEN_237 /* primitive */ udp_identifier TOKEN_12 /* ( */ TOKEN_13 /* .* */ TOKEN_14 /* ) */ TOKEN_0 /* ; */ STAR_42 udp_body TOKEN_238 /* endprimitive */ OPT_142 
    {
        struct ast_udp_declaration *ret = new (struct ast_udp_declaration);
        $$ = ret;
    }
...
udp_port_list 
    : output_port_identifier TOKEN_2 /* , */ LIST_110 
    {
...
udp_declaration_port_list 
    : udp_output_declaration TOKEN_2 /* , */ LIST_111 
    {
...
udp_output_declaration 
    : STAR_2 TOKEN_36 /* output */ port_identifier 
    {
        struct ast_udp_output_declaration *ret = new (struct ast_udp_output_declaration);
        $$ = ret;
    }
    | STAR_2 TOKEN_36 /* output */ TOKEN_116 /* reg */ port_identifier OPT_25 
    {
        struct ast_udp_output_declaration *ret = new (struct ast_udp_output_declaration);
        $$ = ret;
    }
...
udp_input_declaration 
    : STAR_2 TOKEN_35 /* input */ list_of_udp_port_identifiers 
    {
...
combinational_body 
    : TOKEN_239 /* table */ LIST_112 TOKEN_240 /* endtable */ 
    {
...
sequential_body 
    : OPT_143 TOKEN_239 /* table */ LIST_113 TOKEN_240 /* endtable */ 
    {
...
udp_initial_statement 
    : TOKEN_241 /* initial */ output_port_identifier TOKEN_39 /* = */ init_val TOKEN_0 /* ; */ 
    {
...
udp_instantiation 
    : udp_identifier OPT_127 OPT_128 LIST_115 TOKEN_0 /* ; */ 
    {
...
continuous_assign 
    : TOKEN_263 /* assign */ OPT_127 OPT_56 list_of_net_assignments TOKEN_0 /* ; */ 
    {
        struct ast_continuous_assign *ret = new (struct ast_continuous_assign);
        $$ = ret;
    }
    | TOKEN_263 /* assign */ OPT_57 list_of_variable_assignments TOKEN_0 /* ; */ 
    {
        struct ast_continuous_assign *ret = new (struct ast_continuous_assign);
        $$ = ret;
    }
...
net_alias 
    : TOKEN_264 /* alias */ net_lvalue LIST_118 
    {
...
net_assignment 
    : net_lvalue TOKEN_39 /* = */ expression 
    {
...
initial_construct 
    : TOKEN_241 /* initial */ statement_or_null 
    {
...
always_keyword 
    ...
    | TOKEN_266 /* always_comb */ 
    {
        struct ast_always_keyword *ret = new (struct ast_always_keyword);
        $$ = ret;
    }
    | TOKEN_267 /* always_latch */ 
    {
        struct ast_always_keyword *ret = new (struct ast_always_keyword);
        $$ = ret;
    }
...
final_construct 
    : TOKEN_269 /* final */ function_statement 
    {
...
blocking_assignment 
    : variable_lvalue TOKEN_39 /* = */ delay_or_event_control expression 
    {
        struct ast_blocking_assignment *ret = new (struct ast_blocking_assignment);
        $$ = ret;
    }
    | nonrange_variable_lvalue TOKEN_39 /* = */ dynamic_array_new 
    {
        struct ast_blocking_assignment *ret = new (struct ast_blocking_assignment);
        $$ = ret;
    }
    | OPT_144 hierarchical_variable_identifier select TOKEN_39 /* = */ class_new 
    {
        struct ast_blocking_assignment *ret = new (struct ast_blocking_assignment);
        $$ = ret;
    }
...
nonblocking_assignment 
    : variable_lvalue TOKEN_164 /* <= */ OPT_145 expression 
    {
...
procedural_continuous_assignment 
    : TOKEN_263 /* assign */ variable_assignment 
    {
        struct ast_procedural_continuous_assignment *ret = new (struct ast_procedural_continuous_assignment);
        $$ = ret;
    }
    | TOKEN_282 /* deassign */ variable_lvalue 
    {
        struct ast_procedural_continuous_assignment *ret = new (struct ast_procedural_continuous_assignment);
        $$ = ret;
    }
    | TOKEN_283 /* force */ variable_assignment 
    {
        struct ast_procedural_continuous_assignment *ret = new (struct ast_procedural_continuous_assignment);
        $$ = ret;
    }
    | TOKEN_283 /* force */ net_assignment 
    {
        struct ast_procedural_continuous_assignment *ret = new (struct ast_procedural_continuous_assignment);
        $$ = ret;
    }
    | TOKEN_284 /* release */ variable_lvalue 
    {
        struct ast_procedural_continuous_assignment *ret = new (struct ast_procedural_continuous_assignment);
        $$ = ret;
    }
    | TOKEN_284 /* release */ net_lvalue 
    {
        struct ast_procedural_continuous_assignment *ret = new (struct ast_procedural_continuous_assignment);
        $$ = ret;
    }
...
variable_assignment 
    : variable_lvalue TOKEN_39 /* = */ expression 
    {
...
action_block 
    ...
    | OPT_146 TOKEN_77 /* else */ statement_or_null 
    {
        struct ast_action_block *ret = new (struct ast_action_block);
        $$ = ret;
    }
...
seq_block 
    : TOKEN_192 /* begin */ OPT_147 STAR_25 STAR_33 TOKEN_193 /* end */ OPT_147 
    {
...
par_block 
    : TOKEN_285 /* fork */ OPT_147 STAR_25 STAR_33 join_keyword OPT_147 
    {
...
delay_or_event_control 
    ...
    | TOKEN_289 /* repeat */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ event_control 
    {
        struct ast_delay_or_event_control *ret = new (struct ast_delay_or_event_control);
        $$ = ret;
    }
...
delay_control 
    ...
    | TOKEN_30 /* # */ TOKEN_12 /* ( */ mintypmax_expression TOKEN_14 /* ) */ 
    {
        struct ast_delay_control *ret = new (struct ast_delay_control);
        $$ = ret;
    }
...
event_control 
    : TOKEN_290 /* @ */ hierarchical_event_identifier 
    {
        struct ast_event_control *ret = new (struct ast_event_control);
        $$ = ret;
    }
    | TOKEN_290 /* @ */ TOKEN_12 /* ( */ event_expression TOKEN_14 /* ) */ 
    {
        struct ast_event_control *ret = new (struct ast_event_control);
        $$ = ret;
    }
    ...
    | TOKEN_290 /* @ */ TOKEN_12 /* ( */ TOKEN_90 /* * */ TOKEN_14 /* ) */ 
    {
        struct ast_event_control *ret = new (struct ast_event_control);
        $$ = ret;
    }
    | TOKEN_290 /* @ */ ps_or_hierarchical_sequence_identifier 
    {
        struct ast_event_control *ret = new (struct ast_event_control);
        $$ = ret;
    }
...
event_expression 
    : OPT_148 expression OPT_149 
    {
        struct ast_event_expression *ret = new (struct ast_event_expression);
        $$ = ret;
    }
    | sequence_instance OPT_149 
    {
        struct ast_event_expression *ret = new (struct ast_event_expression);
        $$ = ret;
    }
    | event_expression TOKEN_220 /* or */ event_expression 
    {
        struct ast_event_expression *ret = new (struct ast_event_expression);
        $$ = ret;
    }
...
jump_statement 
    : TOKEN_291 /* return */ OPT_27 TOKEN_0 /* ; */ 
    {
        struct ast_jump_statement *ret = new (struct ast_jump_statement);
        $$ = ret;
    }
    | TOKEN_292 /* break */ TOKEN_0 /* ; */ 
    {
        struct ast_jump_statement *ret = new (struct ast_jump_statement);
        $$ = ret;
    }
    | TOKEN_293 /* continue */ TOKEN_0 /* ; */ 
    {
        struct ast_jump_statement *ret = new (struct ast_jump_statement);
        $$ = ret;
    }
...
wait_statement 
    : TOKEN_294 /* wait */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ statement_or_null 
    {
        struct ast_wait_statement *ret = new (struct ast_wait_statement);
        $$ = ret;
    }
    | TOKEN_294 /* wait */ TOKEN_285 /* fork */ TOKEN_0 /* ; */ 
    {
        struct ast_wait_statement *ret = new (struct ast_wait_statement);
        $$ = ret;
    }
    | TOKEN_295 /* wait_order */ TOKEN_12 /* ( */ LIST_120 TOKEN_14 /* ) */ action_block 
    {
        struct ast_wait_statement *ret = new (struct ast_wait_statement);
        $$ = ret;
    }
...
event_trigger 
    ...
    | TOKEN_296 /* ->> */ OPT_145 hierarchical_event_identifier TOKEN_0 /* ; */ 
    {
        struct ast_event_trigger *ret = new (struct ast_event_trigger);
        $$ = ret;
    }
...
disable_statement 
    : TOKEN_49 /* disable */ hierarchical_task_identifier TOKEN_0 /* ; */ 
    {
        struct ast_disable_statement *ret = new (struct ast_disable_statement);
        $$ = ret;
    }
    | TOKEN_49 /* disable */ hierarchical_block_identifier TOKEN_0 /* ; */ 
    {
        struct ast_disable_statement *ret = new (struct ast_disable_statement);
        $$ = ret;
    }
    | TOKEN_49 /* disable */ TOKEN_285 /* fork */ TOKEN_0 /* ; */ 
    {
        struct ast_disable_statement *ret = new (struct ast_disable_statement);
        $$ = ret;
    }
...
conditional_statement 
    : OPT_150 TOKEN_76 /* if */ TOKEN_12 /* ( */ cond_predicate TOKEN_14 /* ) */ statement_or_null STAR_44 OPT_151 
    {
...
cond_pattern 
    : expression TOKEN_203 /* matches */ pattern 
    {
...
case_statement 
    : OPT_150 case_keyword TOKEN_12 /* ( */ case_expression TOKEN_14 /* ) */ LIST_123 TOKEN_236 /* endcase */ 
    {
        struct ast_case_statement *ret = new (struct ast_case_statement);
        $$ = ret;
    }
    | OPT_150 case_keyword TOKEN_12 /* ( */ case_expression TOKEN_14 /* ) */ TOKEN_203 /* matches */ LIST_124 TOKEN_236 /* endcase */ 
    {
        struct ast_case_statement *ret = new (struct ast_case_statement);
        $$ = ret;
    }
    | OPT_150 TOKEN_235 /* case */ TOKEN_12 /* ( */ case_expression TOKEN_14 /* ) */ TOKEN_300 /* inside */ LIST_125 TOKEN_236 /* endcase */ 
    {
        struct ast_case_statement *ret = new (struct ast_case_statement);
        $$ = ret;
    }
...
case_item 
    : LIST_126 TOKEN_6 /* : */ statement_or_null 
    {
        struct ast_case_item *ret = new (struct ast_case_item);
        $$ = ret;
    }
    | TOKEN_47 /* default */ OPT_101 statement_or_null 
    {
        struct ast_case_item *ret = new (struct ast_case_item);
        $$ = ret;
    }
...
case_pattern_item 
    : pattern OPT_152 TOKEN_6 /* : */ statement_or_null 
    {
...
randcase_statement 
    : TOKEN_303 /* randcase */ LIST_127 TOKEN_236 /* endcase */ 
    {
...
pattern 
    ...
    | TOKEN_135 /* tagged */ member_identifier OPT_153 
    {
        struct ast_pattern *ret = new (struct ast_pattern);
        $$ = ret;
    }
    | TOKEN_304 /* ' */ TOKEN_33 /* { */ LIST_129 TOKEN_34 /* } */ 
    {
        struct ast_pattern *ret = new (struct ast_pattern);
        $$ = ret;
    }
    | TOKEN_304 /* ' */ TOKEN_33 /* { */ LIST_130 TOKEN_34 /* } */ 
    {
        struct ast_pattern *ret = new (struct ast_pattern);
        $$ = ret;
    }
...
assignment_pattern 
    : TOKEN_304 /* ' */ TOKEN_33 /* { */ LIST_131 TOKEN_34 /* } */ 
    {
        struct ast_assignment_pattern *ret = new (struct ast_assignment_pattern);
        $$ = ret;
    }
    | TOKEN_304 /* ' */ TOKEN_33 /* { */ LIST_132 TOKEN_34 /* } */ 
    {
        struct ast_assignment_pattern *ret = new (struct ast_assignment_pattern);
        $$ = ret;
    }
    | TOKEN_304 /* ' */ TOKEN_33 /* { */ LIST_133 TOKEN_34 /* } */ 
    {
        struct ast_assignment_pattern *ret = new (struct ast_assignment_pattern);
        $$ = ret;
    }
    | TOKEN_304 /* ' */ TOKEN_33 /* { */ constant_expression TOKEN_33 /* { */ LIST_131 TOKEN_34 /* } */ TOKEN_34 /* } */ 
    {
        struct ast_assignment_pattern *ret = new (struct ast_assignment_pattern);
        $$ = ret;
    }
...
assignment_pattern_net_lvalue 
    : TOKEN_304 /* ' */ TOKEN_33 /* { */ LIST_134 TOKEN_34 /* } */ 
    {
...
assignment_pattern_variable_lvalue 
    : TOKEN_304 /* ' */ TOKEN_33 /* { */ LIST_135 TOKEN_34 /* } */ 
    {
...
loop_statement 
    : TOKEN_305 /* forever */ statement_or_null 
    {
        struct ast_loop_statement *ret = new (struct ast_loop_statement);
        $$ = ret;
    }
    | TOKEN_289 /* repeat */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ statement_or_null 
    {
        struct ast_loop_statement *ret = new (struct ast_loop_statement);
        $$ = ret;
    }
    | TOKEN_306 /* while */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ statement_or_null 
    {
        struct ast_loop_statement *ret = new (struct ast_loop_statement);
        $$ = ret;
    }
    | TOKEN_234 /* for */ TOKEN_12 /* ( */ OPT_155 TOKEN_0 /* ; */ OPT_27 TOKEN_0 /* ; */ OPT_156 TOKEN_14 /* ) */ statement_or_null 
    {
        struct ast_loop_statement *ret = new (struct ast_loop_statement);
        $$ = ret;
    }
    | TOKEN_307 /* do */ statement_or_null TOKEN_306 /* while */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
        struct ast_loop_statement *ret = new (struct ast_loop_statement);
        $$ = ret;
    }
...
subroutine_call_statement 
    ...
    | TOKEN_134 /* void */ TOKEN_304 /* ' */ TOKEN_12 /* ( */ function_subroutine_call TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
        struct ast_subroutine_call_statement *ret = new (struct ast_subroutine_call_statement);
        $$ = ret;
    }
...
deferred_immediate_assert_statement 
    : TOKEN_168 /* assert */ TOKEN_308 /* #0 */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ action_block 
    {
        struct ast_deferred_immediate_assert_statement *ret = new (struct ast_deferred_immediate_assert_statement);
        $$ = ret;
    }
    | TOKEN_168 /* assert */ TOKEN_269 /* final */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ action_block 
    {
        struct ast_deferred_immediate_assert_statement *ret = new (struct ast_deferred_immediate_assert_statement);
        $$ = ret;
    }
...
deferred_immediate_assume_statement 
    : TOKEN_170 /* assume */ TOKEN_308 /* #0 */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ action_block 
    {
        struct ast_deferred_immediate_assume_statement *ret = new (struct ast_deferred_immediate_assume_statement);
        $$ = ret;
    }
    | TOKEN_170 /* assume */ TOKEN_269 /* final */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ action_block 
    {
        struct ast_deferred_immediate_assume_statement *ret = new (struct ast_deferred_immediate_assume_statement);
        $$ = ret;
    }
...
deferred_immediate_cover_statement 
    : TOKEN_171 /* cover */ TOKEN_308 /* #0 */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ statement_or_null 
    {
        struct ast_deferred_immediate_cover_statement *ret = new (struct ast_deferred_immediate_cover_statement);
        $$ = ret;
    }
    | TOKEN_171 /* cover */ TOKEN_269 /* final */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ statement_or_null 
    {
        struct ast_deferred_immediate_cover_statement *ret = new (struct ast_deferred_immediate_cover_statement);
        $$ = ret;
    }
...
clocking_declaration 
    : OPT_158 TOKEN_48 /* clocking */ OPT_159 clocking_event TOKEN_0 /* ; */ STAR_45 TOKEN_309 /* endclocking */ OPT_160 
    {
        struct ast_clocking_declaration *ret = new (struct ast_clocking_declaration);
        $$ = ret;
    }
    | TOKEN_310 /* global */ TOKEN_48 /* clocking */ OPT_159 clocking_event TOKEN_0 /* ; */ TOKEN_309 /* endclocking */ OPT_160 
    {
        struct ast_clocking_declaration *ret = new (struct ast_clocking_declaration);
        $$ = ret;
    }
...
clocking_item 
    : TOKEN_47 /* default */ default_skew TOKEN_0 /* ; */ 
    {
...
default_skew 
    : TOKEN_35 /* input */ clocking_skew 
    {
        struct ast_default_skew *ret = new (struct ast_default_skew);
        $$ = ret;
    }
    | TOKEN_36 /* output */ clocking_skew 
    {
        struct ast_default_skew *ret = new (struct ast_default_skew);
        $$ = ret;
    }
    | TOKEN_35 /* input */ clocking_skew TOKEN_36 /* output */ clocking_skew 
    {
        struct ast_default_skew *ret = new (struct ast_default_skew);
        $$ = ret;
    }
...
clocking_direction 
    : TOKEN_35 /* input */ OPT_161 
    {
        struct ast_clocking_direction *ret = new (struct ast_clocking_direction);
        $$ = ret;
    }
    | TOKEN_36 /* output */ OPT_161 
    {
        struct ast_clocking_direction *ret = new (struct ast_clocking_direction);
        $$ = ret;
    }
    | TOKEN_35 /* input */ OPT_161 TOKEN_36 /* output */ OPT_161 
    {
        struct ast_clocking_direction *ret = new (struct ast_clocking_direction);
        $$ = ret;
    }
...
clocking_drive 
    : clockvar_expression TOKEN_164 /* <= */ OPT_162 expression 
    {
...
cycle_delay 
    : TOKEN_178 /* ## */ integral_number 
    {
        struct ast_cycle_delay *ret = new (struct ast_cycle_delay);
        $$ = ret;
    }
    | TOKEN_178 /* ## */ identifier 
    {
        struct ast_cycle_delay *ret = new (struct ast_cycle_delay);
        $$ = ret;
    }
    | TOKEN_178 /* ## */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ 
    {
        struct ast_cycle_delay *ret = new (struct ast_cycle_delay);
        $$ = ret;
    }
...
randsequence_statement 
    : TOKEN_311 /* randsequence */ TOKEN_12 /* ( */ OPT_163 TOKEN_14 /* ) */ LIST_142 TOKEN_176 /* endsequence */ 
    {
...
production 
    : OPT_164 production_identifier OPT_165 TOKEN_6 /* : */ LIST_143 TOKEN_0 /* ; */ 
    {
...
rs_production_list 
    ...
    | TOKEN_61 /* rand */ TOKEN_286 /* join */ OPT_79 production_item LIST_145 
    {
        struct ast_rs_production_list *ret = new (struct ast_rs_production_list);
        $$ = ret;
    }
...
rs_code_block 
    : TOKEN_33 /* { */ STAR_46 STAR_33 TOKEN_34 /* } */ 
    {
...
rs_if_else 
    : TOKEN_76 /* if */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ production_item OPT_168 
    {
...
rs_repeat 
    : TOKEN_289 /* repeat */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ production_item 
    {
...
rs_case 
    : TOKEN_235 /* case */ TOKEN_12 /* ( */ case_expression TOKEN_14 /* ) */ LIST_147 TOKEN_236 /* endcase */ 
    {
...
rs_case_item 
    : LIST_126 TOKEN_6 /* : */ production_item TOKEN_0 /* ; */ 
    {
        struct ast_rs_case_item *ret = new (struct ast_rs_case_item);
        $$ = ret;
    }
    | TOKEN_47 /* default */ OPT_101 production_item TOKEN_0 /* ; */ 
    {
        struct ast_rs_case_item *ret = new (struct ast_rs_case_item);
        $$ = ret;
    }
...
specify_block 
    : TOKEN_313 /* specify */ STAR_47 TOKEN_314 /* endspecify */ 
    {
...
pulsestyle_declaration 
    : TOKEN_315 /* pulsestyle_onevent */ list_of_path_outputs TOKEN_0 /* ; */ 
    {
        struct ast_pulsestyle_declaration *ret = new (struct ast_pulsestyle_declaration);
        $$ = ret;
    }
    | TOKEN_316 /* pulsestyle_ondetect */ list_of_path_outputs TOKEN_0 /* ; */ 
    {
        struct ast_pulsestyle_declaration *ret = new (struct ast_pulsestyle_declaration);
        $$ = ret;
    }
...
showcancelled_declaration 
    : TOKEN_317 /* showcancelled */ list_of_path_outputs TOKEN_0 /* ; */ 
    {
        struct ast_showcancelled_declaration *ret = new (struct ast_showcancelled_declaration);
        $$ = ret;
    }
    | TOKEN_318 /* noshowcancelled */ list_of_path_outputs TOKEN_0 /* ; */ 
    {
        struct ast_showcancelled_declaration *ret = new (struct ast_showcancelled_declaration);
        $$ = ret;
    }
...
simple_path_declaration 
    : parallel_path_description TOKEN_39 /* = */ path_delay_value 
    {
        struct ast_simple_path_declaration *ret = new (struct ast_simple_path_declaration);
        $$ = ret;
    }
    | full_path_description TOKEN_39 /* = */ path_delay_value 
    {
        struct ast_simple_path_declaration *ret = new (struct ast_simple_path_declaration);
        $$ = ret;
    }
...
parallel_path_description 
    : TOKEN_12 /* ( */ specify_input_terminal_descriptor OPT_169 TOKEN_198 /* => */ specify_output_terminal_descriptor TOKEN_14 /* ) */ 
    {
...
full_path_description 
    : TOKEN_12 /* ( */ list_of_path_inputs OPT_169 TOKEN_319 /* *> */ list_of_path_outputs TOKEN_14 /* ) */ 
    {
...
input_identifier 
    ...
    | interface_identifier TOKEN_32 /* . */ port_identifier 
    {
        struct ast_input_identifier *ret = new (struct ast_input_identifier);
        $$ = ret;
    }
...
edge_sensitive_path_declaration 
    : parallel_edge_sensitive_path_description TOKEN_39 /* = */ path_delay_value 
    {
        struct ast_edge_sensitive_path_declaration *ret = new (struct ast_edge_sensitive_path_declaration);
        $$ = ret;
    }
    | full_edge_sensitive_path_description TOKEN_39 /* = */ path_delay_value 
    {
        struct ast_edge_sensitive_path_declaration *ret = new (struct ast_edge_sensitive_path_declaration);
        $$ = ret;
    }
...
parallel_edge_sensitive_path_description 
    : TOKEN_12 /* ( */ OPT_148 specify_input_terminal_descriptor OPT_169 TOKEN_198 /* => */ TOKEN_12 /* ( */ specify_output_terminal_descriptor OPT_169 TOKEN_6 /* : */ data_source_expression TOKEN_14 /* ) */ TOKEN_14 /* ) */ 
    {
...
full_edge_sensitive_path_description 
    : TOKEN_12 /* ( */ OPT_148 list_of_path_inputs OPT_169 TOKEN_319 /* *> */ TOKEN_12 /* ( */ list_of_path_outputs OPT_169 TOKEN_6 /* : */ data_source_expression TOKEN_14 /* ) */ TOKEN_14 /* ) */ 
    {
...
state_dependent_path_declaration 
    ...
    | TOKEN_323 /* ifnone */ simple_path_declaration 
    {
        struct ast_state_dependent_path_declaration *ret = new (struct ast_state_dependent_path_declaration);
        $$ = ret;
    }
...
dollarsign_setup_timing_check 
    : TOKEN_324 /* dollarsign_setup */ TOKEN_12 /* ( */ data_event TOKEN_2 /* , */ reference_event TOKEN_2 /* , */ timing_check_limit OPT_172 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_hold_timing_check 
    : TOKEN_325 /* dollarsign_hold */ TOKEN_12 /* ( */ reference_event TOKEN_2 /* , */ data_event TOKEN_2 /* , */ timing_check_limit OPT_172 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_setuphold_timing_check 
    : TOKEN_326 /* dollarsign_setuphold */ TOKEN_12 /* ( */ reference_event TOKEN_2 /* , */ data_event TOKEN_2 /* , */ timing_check_limit TOKEN_2 /* , */ timing_check_limit OPT_181 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_recovery_timing_check 
    : TOKEN_327 /* dollarsign_recovery */ TOKEN_12 /* ( */ reference_event TOKEN_2 /* , */ data_event TOKEN_2 /* , */ timing_check_limit OPT_172 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_removal_timing_check 
    : TOKEN_328 /* dollarsign_removal */ TOKEN_12 /* ( */ reference_event TOKEN_2 /* , */ data_event TOKEN_2 /* , */ timing_check_limit OPT_172 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_recrem_timing_check 
    : TOKEN_329 /* dollarsign_recrem */ TOKEN_12 /* ( */ reference_event TOKEN_2 /* , */ data_event TOKEN_2 /* , */ TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_skew_timing_check 
    : TOKEN_330 /* dollarsign_skew */ TOKEN_12 /* ( */ reference_event TOKEN_2 /* , */ data_event TOKEN_2 /* , */ timing_check_limit OPT_172 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_timeskew_timing_check 
    : TOKEN_331 /* dollarsign_timeskew */ TOKEN_12 /* ( */ reference_event TOKEN_2 /* , */ data_event TOKEN_2 /* , */ timing_check_limit OPT_186 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_fullskew_timing_check 
    : TOKEN_332 /* dollarsign_fullskew */ TOKEN_12 /* ( */ reference_event TOKEN_2 /* , */ data_event TOKEN_2 /* , */ timing_check_limit TOKEN_2 /* , */ timing_check_limit OPT_186 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_period_timing_check 
    : TOKEN_333 /* dollarsign_period */ TOKEN_12 /* ( */ TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_width_timing_check 
    : TOKEN_334 /* dollarsign_width */ TOKEN_12 /* ( */ controlled_reference_event TOKEN_2 /* , */ timing_check_limit TOKEN_2 /* , */ threshold OPT_172 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
dollarsign_nochange_timing_check 
    : TOKEN_335 /* dollarsign_nochange */ TOKEN_12 /* ( */ reference_event TOKEN_2 /* , */ data_event TOKEN_2 /* , */ start_edge_offset TOKEN_2 /* , */ end_edge_offset OPT_172 TOKEN_14 /* ) */ TOKEN_0 /* ; */ 
    {
...
timing_check_event 
    : OPT_187 specify_terminal_descriptor OPT_188 
    {
...
controlled_timing_check_event 
    : timing_check_event_control specify_terminal_descriptor OPT_188 
    {
...
edge_control_specifier 
    : TOKEN_322 /* edge */ TOKEN_79 /* [ */ LIST_151 TOKEN_80 /* ] */ 
    {
...
scalar_timing_check_condition 
    ...
    | expression TOKEN_341 /* === */ scalar_constant 
    {
        struct ast_scalar_timing_check_condition *ret = new (struct ast_scalar_timing_check_condition);
        $$ = ret;
    }
    ...
    | expression TOKEN_342 /* !== */ scalar_constant 
    {
        struct ast_scalar_timing_check_condition *ret = new (struct ast_scalar_timing_check_condition);
        $$ = ret;
    }
...
constant_multiple_concatenation 
    : TOKEN_33 /* { */ constant_expression constant_concatenation TOKEN_34 /* } */ 
    {
...
module_path_multiple_concatenation 
    : TOKEN_33 /* { */ constant_expression module_path_concatenation TOKEN_34 /* } */ 
    {
...
multiple_concatenation 
    : TOKEN_33 /* { */ expression concatenation TOKEN_34 /* } */ 
    {
...
streaming_concatenation 
    : TOKEN_33 /* { */ stream_operator OPT_189 stream_concatenation TOKEN_34 /* } */ 
    {
...
stream_concatenation 
    : TOKEN_33 /* { */ expression OPT_190 TOKEN_34 /* } */ 
    {
...
array_range_expression 
    ...
    | expression TOKEN_349 /* +: */ expression 
    {
        struct ast_array_range_expression *ret = new (struct ast_array_range_expression);
        $$ = ret;
    }
    | expression TOKEN_350 /* -: */ expression 
    {
        struct ast_array_range_expression *ret = new (struct ast_array_range_expression);
        $$ = ret;
    }
...
list_of_arguments 
    ...
    | TOKEN_32 /* . */ identifier TOKEN_12 /* ( */ OPT_27 TOKEN_14 /* ) */ STAR_48 
    {
        struct ast_list_of_arguments *ret = new (struct ast_list_of_arguments);
        $$ = ret;
    }
...
method_call 
    : method_call_root TOKEN_32 /* . */ method_call_body 
    {
...
array_manipulation_call 
    : array_method_name STAR_2 OPT_12 OPT_193 
    {
...
randomize_call 
    : TOKEN_352 /* randomize */ STAR_2 OPT_195 OPT_197 
    {
...
conditional_expression 
    : cond_predicate TOKEN_252 /* ? */ STAR_2 expression TOKEN_6 /* : */ expression 
    {
...
constant_expression 
    ...
    | constant_expression TOKEN_252 /* ? */ STAR_2 constant_expression TOKEN_6 /* : */ constant_expression 
    {
        struct ast_constant_expression *ret = new (struct ast_constant_expression);
        $$ = ret;
    }
...
constant_indexed_range 
    : constant_expression TOKEN_349 /* +: */ constant_expression 
    {
        struct ast_constant_indexed_range *ret = new (struct ast_constant_indexed_range);
        $$ = ret;
    }
    | constant_expression TOKEN_350 /* -: */ constant_expression 
    {
        struct ast_constant_indexed_range *ret = new (struct ast_constant_indexed_range);
        $$ = ret;
    }
...
tagged_union_expression 
    : TOKEN_135 /* tagged */ member_identifier OPT_27 
    {
...
inside_expression 
    : expression TOKEN_300 /* inside */ TOKEN_33 /* { */ open_range_list TOKEN_34 /* } */ 
    {
...
module_path_conditional_expression 
    : module_path_expression TOKEN_252 /* ? */ STAR_2 module_path_expression TOKEN_6 /* : */ module_path_expression 
    {
...
indexed_range 
    : expression TOKEN_349 /* +: */ constant_expression 
    {
        struct ast_indexed_range *ret = new (struct ast_indexed_range);
        $$ = ret;
    }
    | expression TOKEN_350 /* -: */ constant_expression 
    {
        struct ast_indexed_range *ret = new (struct ast_indexed_range);
        $$ = ret;
    }
...
constant_primary 
    ...
    | OPT_60 enum_identifier 
    {
        struct ast_constant_primary *ret = new (struct ast_constant_primary);
        $$ = ret;
    }
    | constant_concatenation OPT_170 
    {
        struct ast_constant_primary *ret = new (struct ast_constant_primary);
        $$ = ret;
    }
    | constant_multiple_concatenation OPT_170 
    {
        struct ast_constant_primary *ret = new (struct ast_constant_primary);
        $$ = ret;
    }
...
primary 
    ...
    | OPT_198 hierarchical_identifier select 
    {
        struct ast_primary *ret = new (struct ast_primary);
        $$ = ret;
    }
    ...
    | concatenation OPT_199 
    {
        struct ast_primary *ret = new (struct ast_primary);
        $$ = ret;
    }
    | multiple_concatenation OPT_199 
    {
        struct ast_primary *ret = new (struct ast_primary);
        $$ = ret;
    }
...
implicit_class_handle 
    ...
    | TOKEN_354 /* this */ TOKEN_32 /* . */ TOKEN_69 /* super */ 
    {
        struct ast_implicit_class_handle *ret = new (struct ast_implicit_class_handle);
        $$ = ret;
    }
...
constant_select 
    : OPT_203 constant_bit_select OPT_204 
    {
...
constant_cast 
    : casting_type TOKEN_304 /* ' */ TOKEN_12 /* ( */ constant_expression TOKEN_14 /* ) */ 
    {
...
cast 
    : casting_type TOKEN_304 /* ' */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ 
    {
...
net_lvalue 
    ...
    | TOKEN_33 /* { */ LIST_134 TOKEN_34 /* } */ 
    {
        struct ast_net_lvalue *ret = new (struct ast_net_lvalue);
        $$ = ret;
    }
    | OPT_154 assignment_pattern_net_lvalue 
    {
        struct ast_net_lvalue *ret = new (struct ast_net_lvalue);
        $$ = ret;
    }
...
variable_lvalue 
    : OPT_205 hierarchical_variable_identifier select 
    {
        struct ast_variable_lvalue *ret = new (struct ast_variable_lvalue);
        $$ = ret;
    }
    | TOKEN_33 /* { */ LIST_135 TOKEN_34 /* } */ 
    {
        struct ast_variable_lvalue *ret = new (struct ast_variable_lvalue);
        $$ = ret;
    }
    | OPT_154 assignment_pattern_variable_lvalue 
    {
        struct ast_variable_lvalue *ret = new (struct ast_variable_lvalue);
        $$ = ret;
    }
...
nonrange_variable_lvalue 
    : OPT_205 hierarchical_variable_identifier nonrange_select 
    {
...
decimal_number 
    ...
    | OPT_206 decimal_base unsigned_number 
    {
        struct ast_decimal_number *ret = new (struct ast_decimal_number);
        $$ = ret;
    }
    | OPT_206 decimal_base x_digit STAR_52 
    {
        struct ast_decimal_number *ret = new (struct ast_decimal_number);
        $$ = ret;
    }
    | OPT_206 decimal_base z_digit STAR_52 
    {
        struct ast_decimal_number *ret = new (struct ast_decimal_number);
        $$ = ret;
    }
...
binary_number 
    : OPT_206 binary_base binary_value 
    {
...
octal_number 
    : OPT_206 octal_base octal_value 
    {
...
sign 
    : TOKEN_155 /* + */ 
    {
        struct ast_sign *ret = new (struct ast_sign);
        $$ = ret;
    }
    | TOKEN_157 /* - */ 
    {
...
size 
    ...
    {
        struct ast_size *ret = new (struct ast_size);
        $$ = ret;
    }
    ;

non_zero_unsigned_number 
    : non_zero_decimal_digit STAR_53 
    {
        struct ast_non_zero_unsigned_number *ret = new (struct ast_non_zero_unsigned_number);
        $$ = ret;
    }
    ;
...
real_number 
    ...
    | unsigned_number OPT_207 exp OPT_208 unsigned_number 
    {
        struct ast_real_number *ret = new (struct ast_real_number);
        $$ = ret;
    }
...
fixed_point_number 
    : unsigned_number TOKEN_32 /* . */ unsigned_number 
    {
...
exp 
    : TOKEN_374 /* e */ 
    {
        struct ast_exp *ret = new (struct ast_exp);
        $$ = ret;
    }
    | TOKEN_375 /* E */ 
    {
...
binary_value 
    : binary_digit STAR_54 
    {
        struct ast_binary_value *ret = new (struct ast_binary_value);
        $$ = ret;
    }
    ;
...
octal_value 
    : octal_digit STAR_55 
    {
        struct ast_octal_value *ret = new (struct ast_octal_value);
        $$ = ret;
    }
    ;
...
hex_value 
    : hex_digit STAR_56 
    {
        struct ast_hex_value *ret = new (struct ast_hex_value);
        $$ = ret;
    }
    ;

decimal_base 
    : TOKEN_304 /* ' */ OPT_209 TOKEN_377 /* d */ 
    {
        struct ast_decimal_base *ret = new (struct ast_decimal_base);
        $$ = ret;
    }
    | TOKEN_304 /* ' */ OPT_209 TOKEN_378 /* D */ 
    {
        struct ast_decimal_base *ret = new (struct ast_decimal_base);
        $$ = ret;
    }
...
binary_base 
    : TOKEN_304 /* ' */ OPT_209 TOKEN_253 /* b */ 
    {
        struct ast_binary_base *ret = new (struct ast_binary_base);
        $$ = ret;
    }
    | TOKEN_304 /* ' */ OPT_209 TOKEN_254 /* B */ 
    {
        struct ast_binary_base *ret = new (struct ast_binary_base);
        $$ = ret;
    }
...
octal_base 
    : TOKEN_304 /* ' */ OPT_209 TOKEN_379 /* o */ 
    {
        struct ast_octal_base *ret = new (struct ast_octal_base);
        $$ = ret;
    }
    | TOKEN_304 /* ' */ OPT_209 TOKEN_380 /* O */ 
    {
        struct ast_octal_base *ret = new (struct ast_octal_base);
        $$ = ret;
    }
...
hex_base 
    : TOKEN_304 /* ' */ OPT_209 TOKEN_381 /* h */ 
    {
        struct ast_hex_base *ret = new (struct ast_hex_base);
        $$ = ret;
    }
    | TOKEN_304 /* ' */ OPT_209 TOKEN_382 /* H */ 
    {
        struct ast_hex_base *ret = new (struct ast_hex_base);
        $$ = ret;
    }
...
non_zero_decimal_digit 
    : TOKEN_45 /* 1 */ 
    {
        struct ast_non_zero_decimal_digit *ret = new (struct ast_non_zero_decimal_digit);
        $$ = ret;
    }
    | TOKEN_46 /* 2 */ 
    {
...
decimal_digit 
    : TOKEN_44 /* 0 */ 
    {
        struct ast_decimal_digit *ret = new (struct ast_decimal_digit);
        $$ = ret;
    }
    | TOKEN_45 /* 1 */ 
    {
...
binary_digit 
    : x_digit 
    {
        struct ast_binary_digit *ret = new (struct ast_binary_digit);
        $$ = ret;
    }
    | z_digit 
    {
...
octal_digit 
    : x_digit 
    {
        struct ast_octal_digit *ret = new (struct ast_octal_digit);
        $$ = ret;
    }
    | z_digit 
    {
...
hex_digit 
    : x_digit 
    {
        struct ast_hex_digit *ret = new (struct ast_hex_digit);
        $$ = ret;
    }
    | z_digit 
    {
...
x_digit 
    : TOKEN_250 /* x */ 
    {
        struct ast_x_digit *ret = new (struct ast_x_digit);
        $$ = ret;
    }
    | TOKEN_251 /* X */ 
    {
...
z_digit 
    : TOKEN_338 /* z */ 
    {
        struct ast_z_digit *ret = new (struct ast_z_digit);
        $$ = ret;
    }
    | TOKEN_339 /* Z */ 
    {
...
comment 
    : /* empty */ 
    {
        struct ast_comment *ret = new (struct ast_comment);
        $$ = ret;
    }
    ;
...
one_line_comment 
    : /* empty */ 
    {
        struct ast_one_line_comment *ret = new (struct ast_one_line_comment);
        $$ = ret;
    }
    ;
...
block_comment 
    : /* empty */ 
    {
        struct ast_block_comment *ret = new (struct ast_block_comment);
        $$ = ret;
    }
    ;
...
comment_text 
    : /* empty */ 
    {
        struct ast_comment_text *ret = new (struct ast_comment_text);
        $$ = ret;
    }
    ;
...
array_identifier 
    : identifier 
    {
        struct ast_array_identifier *ret = new (struct ast_array_identifier);
        $$ = ret;
    }
    ;
...
covergroup_variable_identifier 
    : identifier 
    {
        struct ast_covergroup_variable_identifier *ret = new (struct ast_covergroup_variable_identifier);
        $$ = ret;
    }
    ;
...
formal_identifier 
    : identifier 
    {
        struct ast_formal_identifier *ret = new (struct ast_formal_identifier);
        $$ = ret;
    }
    ;
...
package_scope 
    ...
    | TOKEN_398 /* dollarsign_unit */ TOKEN_89 /* :: */ 
    {
        struct ast_package_scope *ret = new (struct ast_package_scope);
        $$ = ret;
    }
...
white_space 
    : /* empty */ 
    {
        struct ast_white_space *ret = new (struct ast_white_space);
        $$ = ret;
    }
    ;
...
LIST_17
    ...
    | LIST_17 TOKEN_2 parameter_port_declaration 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_19
    ...
    | LIST_19 TOKEN_2 STAR_2 ansi_port_declaration 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_20
    ...
    | LIST_20 TOKEN_2 port_reference 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_23
    ...
    | LIST_23 TOKEN_2 bind_target_instance 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_24
    ...
    | LIST_24  local_parameter_declaration TOKEN_0 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_25
    ...
    ;
LIST_26
    : OPT_34 cell_identifier 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_26  OPT_34 cell_identifier 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_27
    : TOKEN_32 instance_identifier 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_27  TOKEN_32 instance_identifier 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_29
    ...
    | LIST_29 TOKEN_2 named_parameter_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_30
    ...
    | LIST_30 TOKEN_2 checker_port_item 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_34
    ...
    | LIST_34  block_item_declaration 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_35
    ...
    | LIST_35  function_statement_or_null 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_37
    ...
    | LIST_37 TOKEN_2 constraint_primary 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_41
    ...
    | LIST_41  anonymous_program_item 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_42
    ...
    | LIST_42 TOKEN_2 package_import_item 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_43
    : net_identifier STAR_15 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_43 TOKEN_2 net_identifier STAR_15 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_46
    ...
    | LIST_46 TOKEN_2 enum_name_declaration 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_47
    ...
    | LIST_47  TOKEN_89 class_identifier OPT_16 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_48
    ...
    | LIST_48 TOKEN_2 defparam_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_49
    ...
    | LIST_49 TOKEN_2 genvar_identifier 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_50
    : interface_identifier STAR_15 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_50 TOKEN_2 interface_identifier STAR_15 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_51
    ...
    | LIST_51 TOKEN_2 net_decl_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_52
    ...
    | LIST_52 TOKEN_2 param_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_53
    : port_identifier STAR_15 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_53 TOKEN_2 port_identifier STAR_15 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_54
    ...
    | LIST_54 TOKEN_2 port_identifier 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_55
    ...
    | LIST_55 TOKEN_2 specparam_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_56
    : port_identifier STAR_16 OPT_74 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_56 TOKEN_2 port_identifier STAR_16 OPT_74 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_57
    ...
    | LIST_57 TOKEN_2 type_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_58
    ...
    | LIST_58 TOKEN_2 variable_decl_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_59
    : variable_identifier STAR_16 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_59 TOKEN_2 variable_identifier STAR_16 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_60
    : port_identifier STAR_16 OPT_25 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_60 TOKEN_2 port_identifier STAR_16 OPT_25 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_66
    ...
    | LIST_66 TOKEN_2 modport_ports_declaration 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_67
    ...
    | LIST_67 TOKEN_2 modport_simple_port 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_68
    ...
    | LIST_68 TOKEN_2 modport_tf_port 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_69
    ...
    ;
LIST_70
    : TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_94 TOKEN_14 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_70  TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_94 TOKEN_14 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_71
    : TOKEN_32 identifier TOKEN_12 OPT_94 TOKEN_14 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_71 TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_94 TOKEN_14 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_72
    ...
    | LIST_72  assertion_variable_declaration 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_73
    ...
    | LIST_73 TOKEN_2 property_port_item 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_77
    ...
    ;
LIST_78
    : TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_109 TOKEN_14 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_78  TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_109 TOKEN_14 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_79
    : TOKEN_32 identifier TOKEN_12 OPT_109 TOKEN_14 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_79 TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_109 TOKEN_14 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_81
    ...
    ;
LIST_82
    : TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_116 TOKEN_14 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_82  TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_116 TOKEN_14 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_83
    : TOKEN_32 identifier TOKEN_12 OPT_116 TOKEN_14 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_83 TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_116 TOKEN_14 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_84
    ...
    | LIST_84  coverage_spec_or_option 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_85
    ...
    | LIST_85  bins_or_options TOKEN_0 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_86
    ...
    | LIST_86 TOKEN_2 TOKEN_12 trans_set TOKEN_14 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_87
    ...
    | LIST_87 TOKEN_198 trans_range_list 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_89
    ...
    | LIST_89  cross_body_item TOKEN_0 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_90
    ...
    | LIST_90 TOKEN_2 covergroup_value_range 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_91
    ...
    | LIST_91 TOKEN_2 cmos_switch_instance 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_92
    ...
    | LIST_92 TOKEN_2 enable_gate_instance 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_93
    ...
    | LIST_93 TOKEN_2 mos_switch_instance 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_94
    ...
    | LIST_94 TOKEN_2 n_input_gate_instance 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_95
    ...
    | LIST_95 TOKEN_2 n_output_gate_instance 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_96
    ...
    | LIST_96 TOKEN_2 pass_enable_switch_instance 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_97
    ...
    | LIST_97 TOKEN_2 pass_switch_instance 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_98
    ...
    | LIST_98 TOKEN_2 pull_gate_instance 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_99
    ...
    | LIST_99 TOKEN_2 input_terminal 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_100
    ...
    | LIST_100 TOKEN_2 output_terminal 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_101
    ...
    | LIST_101 TOKEN_2 hierarchical_instance 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_102
    ...
    | LIST_102 TOKEN_2 ordered_parameter_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_103
    ...
    | LIST_103 TOKEN_2 ordered_port_connection 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_104
    ...
    | LIST_104 TOKEN_2 named_port_connection 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_105
    ...
    | LIST_105 TOKEN_2 ordered_checker_port_connection 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_106
    ...
    | LIST_106 TOKEN_2 named_checker_port_connection 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_108
    ...
    | LIST_108 TOKEN_2 constant_expression 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_110
    ...
    | LIST_110 TOKEN_2 input_port_identifier 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_111
    ...
    | LIST_111 TOKEN_2 udp_input_declaration 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_116
    ...
    | LIST_116 TOKEN_2 net_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_117
    ...
    | LIST_117 TOKEN_2 variable_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_119
    ...
    | LIST_119 TOKEN_2 variable_identifier 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_120
    ...
    | LIST_120 TOKEN_2 hierarchical_identifier 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_121
    ...
    | LIST_121  TOKEN_77 TOKEN_76 TOKEN_12 cond_predicate TOKEN_14 statement_or_null 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_122
    ...
    | LIST_122 TOKEN_299 expression_or_cond_pattern 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_126
    ...
    | LIST_126 TOKEN_2 case_item_expression 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_128
    ...
    | LIST_128 TOKEN_2 open_value_range 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_130
    ...
    | LIST_130 TOKEN_2 member_identifier TOKEN_6 pattern 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_132
    ...
    | LIST_132 TOKEN_2 structure_pattern_key TOKEN_6 expression 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_133
    ...
    | LIST_133 TOKEN_2 array_pattern_key TOKEN_6 expression 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_135
    ...
    | LIST_135 TOKEN_2 variable_lvalue 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_136
    ...
    | LIST_136 TOKEN_2 for_variable_declaration 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_137
    : data_type variable_identifier TOKEN_39 expression 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_137 TOKEN_2 data_type variable_identifier TOKEN_39 expression 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_138
    ...
    | LIST_138 TOKEN_2 for_step_assignment 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_141
    ...
    | LIST_141 TOKEN_2 clocking_decl_assign 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_149
    ...
    | LIST_149 TOKEN_2 specify_input_terminal_descriptor 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_150
    ...
    | LIST_150 TOKEN_2 specify_output_terminal_descriptor 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_151
    ...
    | LIST_151 TOKEN_2 edge_descriptor 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_152
    ...
    | LIST_152 TOKEN_2 module_path_expression 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_153
    ...
    ;
LIST_154
    : TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_27 TOKEN_14 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_154  TOKEN_2 TOKEN_32 identifier TOKEN_12 OPT_27 TOKEN_14 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
LIST_155
    ...
    | LIST_155  TOKEN_79 expression TOKEN_80 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_156
    : TOKEN_32 member_identifier bit_select 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_156  TOKEN_32 member_identifier bit_select 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
    ;
LIST_157
    : TOKEN_32 member_identifier constant_bit_select 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
    }
    | LIST_157  TOKEN_32 member_identifier constant_bit_select 
    {
        ast_list_append($1, $2, AST_UNTYPED);
        $$ = $1;
    }
...
OPT_29
    ...
    | TOKEN_12 /* ( */ finish_number OPT_28 TOKEN_14 /* ) */ 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_43
    ...
    | TOKEN_69 /* super */ TOKEN_32 /* . */ TOKEN_64 /* new */ OPT_12 TOKEN_0 /* ; */ 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_46
    ...
    | implicit_class_handle TOKEN_32 /* . */ 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_61
    ...
    | TOKEN_102 /* with */ OPT_60 tf_identifier 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_68
    ...
    | TOKEN_79 /* [ */ integral_number OPT_67 TOKEN_80 /* ] */ 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_73
    ...
    | TOKEN_2 /* , */ mintypmax_expression OPT_72 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_91
    ...
    | TOKEN_49 /* disable */ TOKEN_50 /* iff */ TOKEN_12 /* ( */ expression_or_dist TOKEN_14 /* ) */ 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_110
    ...
    | TOKEN_184 /* dist */ TOKEN_33 /* { */ dist_list TOKEN_34 /* } */ 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_119
    ...
    | hierarchical_identifier TOKEN_32 /* . */ 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_121
    ...
    | OPT_120 cover_point_identifier TOKEN_6 /* : */ 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_122
    ...
    | TOKEN_50 /* iff */ TOKEN_12 /* ( */ expression TOKEN_14 /* ) */ 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_124
    ...
    | TOKEN_203 /* matches */ integer_covergroup_expression 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_125
    ...
    | TOKEN_205 /* intersect */ TOKEN_33 /* { */ covergroup_range_list TOKEN_34 /* } */ 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_167
    ...
    | TOKEN_82 /* := */ weight_specification OPT_166 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_188
    ...
    | TOKEN_299 /* &&& */ timing_check_condition 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_190
    ...
    | TOKEN_102 /* with */ TOKEN_79 /* [ */ array_range_expression TOKEN_80 /* ] */ stream_concatenation 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_197
    ...
    | TOKEN_102 /* with */ OPT_196 constraint_block 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_201
    ...
    | STAR_50 TOKEN_32 /* . */ member_identifier 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
...
OPT_203
    ...
    | STAR_51 TOKEN_32 /* . */ member_identifier 
    {
        struct ast_list *list = ast_list_new(AST_UNTYPED);
        ast_list_append(list, $1, AST_UNTYPED);
        $$ = list;
